...
const Register = () => {
  ...
  useEffect(() => {
    console.log(
      'REACT_S3_BUCKETNAME',
      process.env.NEXT_PUBLIC_REACT_S3_BUCKETNAME,
    )
  }, [])
              ...
              <Card className="overflow-hidden">
                <CardBody className="pt-0">
                  ...
                  <div className="p-2">
                    ...
                    <div className="mb-3">
                      <Label className="form-label">LEGATIST 활동명</Label>
                    ...
                    <div className="mb-3">
                      <Label className="form-label"> 활동분야</Label>
                    ...
                    <div className="mb-3">
                      <Label className="form-label"> SNS 계정</Label>
